...
class OpenPoseSingleNet(tf.keras.Model):
    ...
    _model_def = {
        ...
        'stage_2#': [
            ['select:stage_1#:backbone#'],   # select two inputs: output from stage1# and output from backbone#.
            ['cnct:'],                       # Is simply a concatenation operation on those 2 previously selected stacks.
            ['cn2_r5_e1_c384_npre'],
